	...
	<script src="<%= request.getContextPath()%>/resources/js/bootstrap-image-gallery.min.js" ></script>
	 ...
	 $(document).ready(function(){
		 ...
		 $.getJSON('http://localhost:8080/trazability/provider/getallprovider', function(data) {
			  ...
			  {
				  var idField = "<td><input type='hidden' value='"+val.id+"'  id='"+val.id+"'/>"+val.name+"</td>";
		...
		{
				$.getJSON('http://localhost:8080/trazability/provider/getprovider/'+id, function(data) {
		...
		function sendDataProviderForDeleted()
		{
			...
			$.get('http://localhost:8080/trazability/provider/delete/'+idProvider, function(data)
			{
...
<div class="container">
	<div class="row">
		...
		<div class="separador"></div>
			...
			<div id="newprovider">
				<a href="#data" class="btn btn-primary" data-toggle="collapse">Nuevo Proveedor</a></div>  
			...
			<h3 class="text-center titulo">Listado de proveedores</h3>
...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    ...
    <h3 id="myModalLabel">MODIFICAR DATOS DE PROVEEDOR</h3>
  </div>
  <div class="modal-body">
  <h4>DATOS ACTUALES DE PROVEEDOR</h4>
