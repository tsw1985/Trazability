...
//	Long actualIdLoteTable = 0L;
	...
	public void run(){
			 ...
			 try 
		     {
		        	...
		        	String sentenciaTemperatura = "update Pasteurizator set actualTemperature='ERROR1' where id='1';";
		            try {
						stmt.execute(sentenciaTemperatura);
		                stmt.close();
		                conn.close();
		        	...
		        	String sentenciaTemperatura = "update Pasteurizator set actualTemperature='ERROR2' where id='1';";
		            try {
						stmt.execute(sentenciaTemperatura);
		                stmt.close();
		                conn.close();
			    	...
			    	timer.cancel();
		        	String sentenciaTemperatura = "update Pasteurizator set actualTemperature='ERROR3' where id='1';";
		            try {
						stmt.execute(sentenciaTemperatura);
		                stmt.close();
		                conn.close();
